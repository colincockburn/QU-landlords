  ...
  return (
    <nav className="flex w-full justify-between items-center text-sm h-12 md:h-20 font-custom border-b border-black px-5 md:px-10 lg:px-20">
      <div className='flex justify-start items-center w-1/2'>
        <img src="/flag.png" alt="Queens Flag " className='w-20 h-12 mr-2' />
      ...
      <div className='flex justify-between w-1/2 2xl:pl-40 md:text-xl font-semibold text-black'>
        ...
        {/* <a href="mailto:your-email@example.com" className="hover:text-gray-700 transform transition duration-500 ease-in-out hover:scale-110">Email us</a> */}
        <a href="https://www.youtube.com/watch?v=dQw4w9WgXcQ" className="hover:text-gray-700 transform transition duration-500 ease-in-out hover:scale-110">Email us</a>
