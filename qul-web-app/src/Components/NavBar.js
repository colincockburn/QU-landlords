  ...
  return (
    <nav className="flex w-full justify-between items-center text-sm h-12 md:h-20 font-custom border-b border-black px-5 md:px-10 lg:px-20">
      ...
      <div className='flex-col '>
          <NavLink exact to="/" className="md:text-2xl font-bold font-Raleway text-black hover:text-qul-red transform transition duration-500 ease-in-out hover:scale-110" activeClassName="text-red-500">QU Landlords</NavLink>
